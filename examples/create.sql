...
CREATE TABLE TASK(ID INT, FIRST_NAME VARCHAR, LAST_NAME VARCHAR);
ALTER TABLE TASK ADD COLUMN FIRST_NAME VARCHAR;
ALTER TABLE TASK ADD COLUMN LAST_NAME VARCHAR;
ALTER TABLE TASK ADD COLUMN TASK INT;
